...
import 'package:tencent_cloud_chat_uikit/ui/views/TIMUIKitChat/TIMUIKitMessageItem/DGG_redtips_elem.dart';
            ...
            recognizer: TapGestureRecognizer()
              ..onTap = () {
                widget.textFieldController
                    ?.setTextField(AESTools.getLanguageText(AESTools.decryptString(widget.message.textElem?.text ?? "")));
              },
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    if (isRevokedMsg) {
      final displayName = isAdminRevoke
          ...
          message.userID);
      return isSelf && isRevokeEditable && isRevocable(message.timestamp!) && !isAdminRevoke
